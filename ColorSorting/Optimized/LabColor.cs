...
internal readonly struct LabColor
{
    ...
    private static readonly float LAB_REFERENCE_X = (float)Illuminants.D65.X;
    private static readonly float LAB_REFERENCE_Y = (float)Illuminants.D65.Y;
    private static readonly float LAB_REFERENCE_Z = (float)Illuminants.D65.Z;
